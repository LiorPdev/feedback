...
export const REWARD_PRODUCTION = 2;         // Tokens reward for each production point in a feedback.
export const REWARD_VOCALS = 2;             // Tokens reward for each vocals point in a feedback.
export const REWARD_OVERALL = 2;            // Tokens reward for each overall point in a feedback.
