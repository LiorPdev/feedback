...
export default function UserPreferencesModal({
  ...
  const updateSocialLink = (platform: keyof SocialLinks, value: string) => {
    ...
    if (trimmed.startsWith('http')) {
      // Split by any whitespace and take the first part that is a URL
    ...
    setSocialLinks(prev => ({ ...prev, [platform]: finalValue }));
  };
        ...
        <div className={styles.overlay} onClick={onClose}>
          ...
          >
            ...
            <div className={styles.content}>
              ...
              <div className={styles.formGroupNoGap}>
                <h3 className={styles.sectionTitle}>המוזיקה שלי</h3>
