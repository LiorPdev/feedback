...
export default function SocialIcon({ platform, size = 16, className }: SocialIconProps) {
  ...
  if (p === "tiktok") {
    return (
      <svg viewBox="0 0 24 24" width={size} height={size} fill="currentColor" className={className}>
        <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.86-.6-4.12-1.31a8.6 8.6 0 0 1-1.87-1.33v7.41c.02 2.13-.58 4.31-2.03 5.89-1.45 1.58-3.64 2.41-5.77 2.22-2.12-.19-4.16-1.42-5.18-3.3a8.9 8.9 0 0 1-1-4.4c.04-2.12.87-4.23 2.51-5.59 1.63-1.36 3.91-1.89 5.95-1.41v4.1c-1.04-.32-2.22-.09-3.05.65-.83.74-1.22 1.88-1.11 2.98a3.5 3.5 0 0 0 3.77 3.14 3.5 3.5 0 0 0 3.2-3.61V.02z" />
      </svg>
    );
  }
