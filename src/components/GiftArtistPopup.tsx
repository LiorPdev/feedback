        ...
        >
          ...
          >
            ...
            <div className={styles.header}>
              <h2 className={styles.title}>מתנה קטנה לאמן</h2>
              <Gift size={26} className={styles.headerIcon} />
            </div>

            <div className={styles.body}>
              <div className={styles.field}>
                <label className={styles.label}>הודעה אישית (אופציונאלי)</label>
                <textarea
                  className={styles.textarea}
                  placeholder="כתבו כאן משהו נחמד לאמן..."
                  value={message}
              ...
              <div className={styles.field}>
                <label className={styles.label}>שם שלי או כינוי (אופציונאלי)</label>
                <input
                  type="text"
                  className={styles.nameInput}
                  placeholder="מעריץ 1376"
                  value={senderName}
              ...
              <div className={styles.field}>
                <label className={styles.label}>פרגנו לאמן בנק&apos; קרדיט</label>
            ...
            <div className={styles.footer}>
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? <Loader2 className={styles.spin} size={20} /> : "שליחה"}
              </button>
            </div>
          </motion.div>
        </motion.div>
