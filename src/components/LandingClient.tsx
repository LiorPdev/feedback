          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "מתלבטים איזה שיר כדאי לקדם? איזה שיר להוציא כסינגל? לא בטוחים איזה עיבוד עובד טוב יותר? העלו מספר שירים ונתבו את ההשקעה והתקציב שלכם בשירים עם הפוטנציאל הגבוה ביותר להצליח.",
                icon: <CheckCircle />
              },
              {
