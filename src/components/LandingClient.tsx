            ...
            {[
              {
                ...
                desc: "נמאס לקבל לייקים רק כי לא נעים להם להגיד את האמת? כאן תקבל חוות דעת מאנשים שלא מכירים אותך ולא חייבים לך כלום. פשוט פידבק אנונימי אמיתי שיעזור לך להשתפר.",
                icon: <CheckCircle />
              },
              {
                title: "פידבק אנונימי",
